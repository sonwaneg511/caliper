...
@Component
public class DeleteUserRule implements Rule{
	...
	public void validate(UserActionRequest request, UserActionContext context) {
	    ...
	    if (targetIsSuperAdmin) {
	        throw new SecurityException("Super Admin cannot be deleted");
	    }

	    //ADMIN cannot delete ADMIN
	    if (currIsAdmin && targetIsAdmin) {
	        throw new SecurityException("Admin is not allowed to delete another Admin");
	    }

	    //ADMIN cannot delete SUPER ADMIN
	    if (currIsAdmin && targetIsSuperAdmin) {
	        throw new SecurityException("Admin is not allowed to delete Super Admin");
	    }
